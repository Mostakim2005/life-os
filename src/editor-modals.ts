/* eslint-disable @typescript-eslint/no-misused-promises -- Modal save actions launch asynchronous plugin persistence from void-returning Obsidian button callbacks. */
